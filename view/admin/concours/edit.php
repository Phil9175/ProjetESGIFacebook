	...
	<div class="row">
		<div class="col-md-6 col-sm-6 col-xs-12">
			<form class="form-horizontal" action="https://www.concoursphotosesgi.com/admin/edit/<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="date_fin"> Couleur de la police </label>
					<div class="col-sm-10">
						<input class="form-control" id="picker_font" name="picker_font" value="<?php echo $date_fin; ?>"/>
					</div>
				</div>
				<div class="form-group">
...
$( document ).ready(function() {
  // Handler for .ready() called.
	$('#picker_font').colorpicker({ flat: true });
});
</script>
